...
CREATE TABLE `ootb_choice_option` (
  ...
  `belong_to_table` varchar(32) DEFAULT NULL,
  PRIMARY KEY (`uuid`),
  KEY `module` (`module`),
  KEY `domain` (`domain`),
  KEY `choice_for_column` (`choice_for_column`),
  KEY `language` (`language`),
  KEY `belong_to` (`belong_to_table`),
  CONSTRAINT `ootb_choice_option_ibfk_2` FOREIGN KEY (`module`) REFERENCES `ootb_module` (`uuid`),
  CONSTRAINT `ootb_choice_option_ibfk_3` FOREIGN KEY (`domain`) REFERENCES `ootb_domain` (`uuid`),
  CONSTRAINT `ootb_choice_option_ibfk_4` FOREIGN KEY (`choice_for_column`) REFERENCES `ootb_system_table_column` (`uuid`),
  CONSTRAINT `ootb_choice_option_ibfk_5` FOREIGN KEY (`language`) REFERENCES `ootb_language` (`uuid`),
  CONSTRAINT `ootb_choice_option_ibfk_6` FOREIGN KEY (`belong_to_table`) REFERENCES `ootb_system_table` (`uuid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `ootb_otom_rest_api_operation`
--

DROP TABLE IF EXISTS `ootb_otom_rest_api_operation`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `ootb_otom_rest_api_operation` (
  `uuid` varchar(32) NOT NULL DEFAULT md5(uuid()),
  PRIMARY KEY (`uuid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Dumping data for table `ootb_otom_rest_api_operation`
--

LOCK TABLES `ootb_otom_rest_api_operation` WRITE;
/*!40000 ALTER TABLE `ootb_otom_rest_api_operation` DISABLE KEYS */;
/*!40000 ALTER TABLE `ootb_otom_rest_api_operation` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `ootb_rest_api_definition`
--

DROP TABLE IF EXISTS `ootb_rest_api_definition`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `ootb_rest_api_definition` (
  `uuid` varchar(32) NOT NULL DEFAULT md5(uuid()),
  PRIMARY KEY (`uuid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Dumping data for table `ootb_rest_api_definition`
--

LOCK TABLES `ootb_rest_api_definition` WRITE;
/*!40000 ALTER TABLE `ootb_rest_api_definition` DISABLE KEYS */;
/*!40000 ALTER TABLE `ootb_rest_api_definition` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `ootb_system_column_wrapper` (
  ...
  KEY `domain` (`domain`),
  KEY `language` (`language`),
  CONSTRAINT `ootb_system_column_wrapper_ibfk_1` FOREIGN KEY (`belongs_to`) REFERENCES `ootb_system_table` (`uuid`),
  CONSTRAINT `ootb_system_column_wrapper_ibfk_2` FOREIGN KEY (`wrapper_for`) REFERENCES `ootb_system_table_column` (`uuid`),
  CONSTRAINT `ootb_system_column_wrapper_ibfk_3` FOREIGN KEY (`module`) REFERENCES `ootb_module` (`uuid`),
  CONSTRAINT `ootb_system_column_wrapper_ibfk_4` FOREIGN KEY (`domain`) REFERENCES `ootb_domain` (`uuid`),
  CONSTRAINT `ootb_system_column_wrapper_ibfk_5` FOREIGN KEY (`language`) REFERENCES `ootb_language` (`uuid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ootb_system_table` (
  ...
  `inherited_from_table` varchar(32) DEFAULT NULL,
  ...
  CONSTRAINT `ootb_system_table_ibfk_1` FOREIGN KEY (`module`) REFERENCES `ootb_module` (`uuid`),
  CONSTRAINT `ootb_system_table_ibfk_2` FOREIGN KEY (`domain`) REFERENCES `ootb_domain` (`uuid`),
  CONSTRAINT `ootb_system_table_ibfk_3` FOREIGN KEY (`inherited_from_table`) REFERENCES `ootb_system_table` (`uuid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `ootb_system_table` VALUES ('29796aa9bbe2ca355a760a54782d0336',NULL,NULL,'System Table','ootb_system_table',NULL,0,0,0),('2b1d66ba7f28a49b302821047e2ed234',NULL,NULL,'Table Column Type','ootb_system_table_column_type','29796aa9bbe2ca355a760a54782d0336',0,0,0),('2c8ef65769ffa3fb3c202a9545907ea4',NULL,NULL,'Table Column','ootb_system_table_column','29796aa9bbe2ca355a760a54782d0336',0,0,0),('6f4111da4d7a8389a69521c352aa3a3e',NULL,NULL,'Users','ootb_user',NULL,0,0,0),('7c055578108bcd98f761728b4e5389f5',NULL,NULL,'Configuration Item','ootb_config_item','29796aa9bbe2ca355a760a54782d0336',0,0,0),('89aaef910b31c721f10140477430545a',NULL,NULL,'Domain','ootb_domain','29796aa9bbe2ca355a760a54782d0336',0,0,0),('a06cdc922aedf881b60fad9d254cff3a',NULL,NULL,'System Module','ootb_module','29796aa9bbe2ca355a760a54782d0336',0,0,0),('cbac3265b1746b7d2a6740724e2af055',NULL,NULL,'Choice Option','ootb_choice_option','29796aa9bbe2ca355a760a54782d0336',0,0,0),('cc6e3f8a3b5a00b42df974f95089b593',NULL,NULL,'Table Column Wrapper','ootb_system_table_column_type','29796aa9bbe2ca355a760a54782d0336',0,0,0);
...
CREATE TABLE `ootb_system_table_column` (
  ...
  `system_column` tinyint(1) DEFAULT NULL COMMENT 'the column can''t deleted',
  ...
  CONSTRAINT `ootb_system_table_column_ibfk_1` FOREIGN KEY (`domain`) REFERENCES `ootb_domain` (`uuid`),
  CONSTRAINT `ootb_system_table_column_ibfk_2` FOREIGN KEY (`belongs_to`) REFERENCES `ootb_system_table` (`uuid`),
  CONSTRAINT `ootb_system_table_column_ibfk_3` FOREIGN KEY (`column_type`) REFERENCES `ootb_system_table_column_type` (`uuid`),
  CONSTRAINT `ootb_system_table_column_ibfk_4` FOREIGN KEY (`reference_to`) REFERENCES `ootb_system_table` (`uuid`),
...
INSERT INTO `ootb_system_table_column` VALUES ('05b2cb83709ce686265232ec177ee784',NULL,NULL,'2b1d66ba7f28a49b302821047e2ed234','a7b5dc4c768cb2e7021c1af50c3c342a','UUID','uuid',NULL,NULL,'Column Type',1,0,0,0,NULL,NULL,NULL),('0dc026e48237fd5f2b98b5847e9aa546',NULL,NULL,'29796aa9bbe2ca355a760a54782d0336','a7b5dc4c768cb2e7021c1af50c3c342a','UUID','uuid',NULL,NULL,'Table',1,0,0,0,NULL,NULL,NULL),('281271cb81a996cba417da65e48d7e03',NULL,NULL,'cc6e3f8a3b5a00b42df974f95089b593','2486eda639ba00c07c7236b21e77e09b','Language','language',NULL,NULL,NULL,1,0,0,0,NULL,NULL,NULL),('30d6fbc6bf6755a94a5d5c5b05d0455d',NULL,NULL,'2c8ef65769ffa3fb3c202a9545907ea4','a7b5dc4c768cb2e7021c1af50c3c342a','UUID','uuid',NULL,NULL,'Column',1,0,0,0,NULL,NULL,NULL),('39a065d0714de2b0f23ce3a14bbecbe8',NULL,NULL,'2c8ef65769ffa3fb3c202a9545907ea4','2486eda639ba00c07c7236b21e77e09b','Module','module',NULL,NULL,NULL,1,0,0,0,NULL,NULL,NULL),('48b8426964e3ca7b4e664f5cda857c07',NULL,NULL,'cc6e3f8a3b5a00b42df974f95089b593','3f31b27e16efbf0d422e94126fa0bcfd','Help Text','help_text',NULL,NULL,NULL,1,0,0,0,NULL,NULL,NULL),('4eaf0e910fb9574c6cdcdb6b121b802d',NULL,NULL,'29796aa9bbe2ca355a760a54782d0336','2486eda639ba00c07c7236b21e77e09b','Module','module',NULL,NULL,NULL,1,0,0,0,NULL,NULL,NULL),('61f387265daf9869012ba05e0217e4ab',NULL,NULL,'2c8ef65769ffa3fb3c202a9545907ea4','2486eda639ba00c07c7236b21e77e09b','Domain','domain',NULL,NULL,NULL,1,0,0,0,NULL,NULL,NULL),('6973bbca368ae8414248c90586e7d132',NULL,NULL,'29796aa9bbe2ca355a760a54782d0336','2486eda639ba00c07c7236b21e77e09b','Domain','domain',NULL,NULL,NULL,1,0,0,0,NULL,NULL,NULL),('6e9236cb5b4f67157449485bddfdf0c4',NULL,NULL,'29796aa9bbe2ca355a760a54782d0336','3f31b27e16efbf0d422e94126fa0bcfd','Table Display Name','table_display_name',NULL,NULL,NULL,1,0,0,0,NULL,NULL,NULL),('753edcb8309d46e8445d8d7613526c1f',NULL,NULL,'2c8ef65769ffa3fb3c202a9545907ea4','2486eda639ba00c07c7236b21e77e09b','Belongs to','belongs_to',NULL,NULL,NULL,1,0,0,0,NULL,NULL,NULL),('78e04c6c11db78f7e14a26c695c16e50',NULL,NULL,'cc6e3f8a3b5a00b42df974f95089b593','a7b5dc4c768cb2e7021c1af50c3c342a','UUID','uuid',NULL,NULL,'Wrapper',1,0,0,0,NULL,NULL,NULL),('80ef3ee151fb53f264db35286ec815da',NULL,NULL,'29796aa9bbe2ca355a760a54782d0336','3f31b27e16efbf0d422e94126fa0bcfd','Table Actual Name','table_actual_name',NULL,NULL,NULL,1,0,0,0,NULL,NULL,NULL),('83f5e4cda7ba0299220880ad4ebb2480',NULL,NULL,'2c8ef65769ffa3fb3c202a9545907ea4','2486eda639ba00c07c7236b21e77e09b','Column Type','column_type',NULL,NULL,NULL,1,0,0,0,NULL,NULL,NULL),('88bea698312cbae3b50353fb436ea647',NULL,NULL,'2c8ef65769ffa3fb3c202a9545907ea4','3f31b27e16efbf0d422e94126fa0bcfd','Column Display Name','column_display_name',NULL,NULL,NULL,1,0,0,0,NULL,NULL,NULL),('8cfbcd1d0b70d1ff3d5ecdf31aafa6d9',NULL,NULL,'cc6e3f8a3b5a00b42df974f95089b593','2486eda639ba00c07c7236b21e77e09b','Module','module',NULL,NULL,NULL,1,0,0,0,NULL,NULL,NULL),('9812df2cf2757c427a296c168869f220',NULL,NULL,'2b1d66ba7f28a49b302821047e2ed234','84cbc53855c398f8cd7324e03e9fa369','Attributes','attributes',NULL,NULL,NULL,1,0,0,0,NULL,NULL,NULL),('9bfeb5278ca4316a6fb84eb281398e94',NULL,NULL,'2c8ef65769ffa3fb3c202a9545907ea4','3f31b27e16efbf0d422e94126fa0bcfd','Column Actual Name','column_actual_name',NULL,NULL,NULL,1,0,0,0,NULL,NULL,NULL),('9f080b3bdde7290e0a091820f37bedd4',NULL,NULL,'29796aa9bbe2ca355a760a54782d0336','2486eda639ba00c07c7236b21e77e09b','Inherited From Table','inherited_from_table',NULL,NULL,NULL,1,0,0,0,NULL,NULL,NULL),('9fa33ba0a88985f38f66040d09d618c2',NULL,NULL,'29796aa9bbe2ca355a760a54782d0336','6de0e7cd5bd1d1f67982cec016e448f3','Allow to Inherited','allow_to_inheriting',NULL,NULL,NULL,1,0,0,0,NULL,NULL,NULL),('a289c025bb7c796aa6cad1d5554ef2ae',NULL,NULL,'2b1d66ba7f28a49b302821047e2ed234','093f9f75162eef5e54ad0fb482709b23','Length','length',NULL,NULL,NULL,1,0,0,0,NULL,NULL,NULL),('a74dd99ceec41e719eefa243c621b8e4',NULL,NULL,'cc6e3f8a3b5a00b42df974f95089b593','2486eda639ba00c07c7236b21e77e09b','Belongs to','belongs_to',NULL,NULL,NULL,1,0,0,0,NULL,NULL,NULL),('a8d8ce27ab65d65b139a16617ebf0f80',NULL,NULL,'2b1d66ba7f28a49b302821047e2ed234','3f31b27e16efbf0d422e94126fa0bcfd','Display Name','display_name',NULL,NULL,NULL,1,0,0,0,NULL,NULL,NULL),('ad1b4bffec317d51bbd7c980bf9ca97d',NULL,NULL,'2c8ef65769ffa3fb3c202a9545907ea4','093f9f75162eef5e54ad0fb482709b23','Length Limit','length_limit',NULL,NULL,NULL,1,0,0,0,NULL,NULL,NULL),('ae61370c78137bbeb0cc95cf3f5df1da',NULL,NULL,'cc6e3f8a3b5a00b42df974f95089b593','2486eda639ba00c07c7236b21e77e09b','Wrapper for','wrapper_for',NULL,NULL,NULL,1,0,0,0,NULL,NULL,NULL),('b1652602ee6e84f1422013d845d98c19',NULL,NULL,'29796aa9bbe2ca355a760a54782d0336','6de0e7cd5bd1d1f67982cec016e448f3','Free Table','free_table',NULL,NULL,NULL,1,0,0,0,NULL,NULL,NULL),('b2c2a639e4db0a848864ce0f43182bd2',NULL,NULL,'2c8ef65769ffa3fb3c202a9545907ea4','84cbc53855c398f8cd7324e03e9fa369','Attributes','attributes',NULL,NULL,NULL,1,0,0,0,NULL,NULL,NULL),('c3e2e749830ab2c9cf7bf0184affcf90',NULL,NULL,'2c8ef65769ffa3fb3c202a9545907ea4','3f31b27e16efbf0d422e94126fa0bcfd','Comment','comment',NULL,NULL,NULL,1,0,0,0,NULL,NULL,NULL),('d208e1fbb11445b0e830a91858810a5d',NULL,NULL,'2c8ef65769ffa3fb3c202a9545907ea4','6de0e7cd5bd1d1f67982cec016e448f3','Active','active',NULL,NULL,NULL,1,0,0,0,NULL,NULL,NULL),('d4c311031f1651222e9ad80aa5c32fef',NULL,NULL,'2c8ef65769ffa3fb3c202a9545907ea4','6de0e7cd5bd1d1f67982cec016e448f3','Read-Only','read_only',NULL,NULL,NULL,1,0,0,0,NULL,NULL,NULL),('d60911f1a2ba5e2be5e88393a9e7b4c1',NULL,NULL,'2b1d66ba7f28a49b302821047e2ed234','9a809eb197abe78cbead146584662fd4','Derived From','derived_from',NULL,NULL,NULL,1,0,0,0,NULL,NULL,NULL),('db4e443e017dcb9dbcbc6024044fce7d',NULL,NULL,'2c8ef65769ffa3fb3c202a9545907ea4','6de0e7cd5bd1d1f67982cec016e448f3','Mandatory','mandatory',NULL,NULL,NULL,1,0,0,0,NULL,NULL,NULL),('dc23ad44cbc80d1466b19c2c2aa432b6',NULL,NULL,'cc6e3f8a3b5a00b42df974f95089b593','2486eda639ba00c07c7236b21e77e09b','Domain','domain',NULL,NULL,NULL,1,0,0,0,NULL,NULL,NULL),('e95dedf0662da669308043eb8343a65a',NULL,NULL,'2c8ef65769ffa3fb3c202a9545907ea4','6de0e7cd5bd1d1f67982cec016e448f3','Represent for Record','represent_for_record',NULL,NULL,NULL,1,0,0,0,NULL,NULL,NULL),('e98a9eb5e0e638400c06ee599885d489',NULL,NULL,'cc6e3f8a3b5a00b42df974f95089b593','c809ff75076bc9b4e20de5c1a55a8969','URL','url',NULL,NULL,NULL,1,0,0,0,NULL,NULL,NULL),('e9b52a996bc896b478165d4fa52c7d21',NULL,NULL,'2b1d66ba7f28a49b302821047e2ed234','3f31b27e16efbf0d422e94126fa0bcfd','Name','name',NULL,NULL,NULL,1,0,0,0,NULL,NULL,NULL),('ecf7e24cc2f33dc24af9b4cd64dfaa17',NULL,NULL,'cc6e3f8a3b5a00b42df974f95089b593','3f31b27e16efbf0d422e94126fa0bcfd','Display Value','display_name',NULL,NULL,NULL,1,0,0,0,NULL,NULL,NULL),('ee40940849000f68e8d70160a56daf89',NULL,NULL,'2c8ef65769ffa3fb3c202a9545907ea4','2486eda639ba00c07c7236b21e77e09b','Reference to','reference_to',NULL,NULL,NULL,1,0,0,0,NULL,NULL,NULL),('ef708cf1bb65ccddfd4d0c2f5aa011ed',NULL,NULL,'29796aa9bbe2ca355a760a54782d0336','6de0e7cd5bd1d1f67982cec016e448f3','Public Table','public_table',NULL,NULL,NULL,1,0,0,0,NULL,NULL,NULL),('f1313796a7708eb44aba3d79c2539024',NULL,NULL,'2c8ef65769ffa3fb3c202a9545907ea4','6de0e7cd5bd1d1f67982cec016e448f3','System Column','system_column',NULL,NULL,NULL,1,0,0,0,NULL,NULL,NULL),('f586034c8e7520b59bd127f6805a5a06',NULL,NULL,'2b1d66ba7f28a49b302821047e2ed234','2486eda639ba00c07c7236b21e77e09b','Module','module',NULL,NULL,NULL,1,0,0,0,NULL,NULL,NULL),('f60a2a7d7b3302021b66b96f7ee9a97d',NULL,NULL,'2c8ef65769ffa3fb3c202a9545907ea4','6de0e7cd5bd1d1f67982cec016e448f3','Can be Viewed','can_be_viewed',NULL,NULL,NULL,1,0,0,0,NULL,NULL,NULL);
...
CREATE TABLE `ootb_user` (
  ...
  KEY `domain` (`domain`),
  KEY `module` (`module`),
  CONSTRAINT `ootb_user_ibfk_1` FOREIGN KEY (`record_created_by_user`) REFERENCES `ootb_user` (`uuid`),
  CONSTRAINT `ootb_user_ibfk_2` FOREIGN KEY (`record_last_updated_by_user`) REFERENCES `ootb_user` (`uuid`),
  CONSTRAINT `ootb_user_ibfk_3` FOREIGN KEY (`domain`) REFERENCES `ootb_domain` (`uuid`),
...
CREATE TABLE `ootb_user_preference` (
  ...
  CONSTRAINT `ootb_user_preference_ibfk_1` FOREIGN KEY (`for_user`) REFERENCES `ootb_user` (`uuid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2022-01-25 15:04:42
